	...
	namespace Math
	{
		...
		public:
			...
			*/
			...
			ContainmentType Contains(Vector3 vector)
			{
			...
			*/
			...
			static BoundingBox FromSphere(BoundingBox& res, const BoundingSphere& sphere)
			{
			...
			static BoundingBox Merge(BoundingBox box1, const BoundingBox box2)
			{
				BoundingBox box3;
