...
namespace Apoc3D
{
	namespace Graphics
	{
		...
		{			
			...
			class _Export VertexBuffer : public HardwareBuffer
			{
			protected:
			...
			class _Export IndexBuffer : public HardwareBuffer
			{
			private:
			...
			class _Export DepthBuffer : public HardwareBuffer
			{
			private:
				int m_width;
				int m_height;
