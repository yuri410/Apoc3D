	...
	namespace Graphics
	{
		namespace RenderSystem
		{
			void* HardwareBuffer::Lock(LockMode mode)
			{
				...
				throw AP_EXCEPTION(ApocExceptionType::InvalidOperation, L"Buffer already Locked.");
			}
			...
			void HardwareBuffer::Unlock()
			{
				...
				{
					throw AP_EXCEPTION(ApocExceptionType::InvalidOperation, L"Buffer is not locked");
				}
			}
