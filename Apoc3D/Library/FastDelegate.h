...
#ifdef _MSC_VER
static_assert(_MSC_VER >= 1300, "VC6 not supported");
#endif
...
class FastDelegate < RetType(ArgTypes...) >
{
private:
	typedef RetType(*StaticFunctionPtr)(ArgTypes...);
	typedef RetType(*UnvoidStaticFunctionPtr)(ArgTypes...);
	typedef RetType(detail::GenericClass::*GenericMemFn)(ArgTypes...);
...
public:
	...
	FastDelegate(Y *pthis, RetType(X::* function_to_bind)(ArgTypes...))
	{
	...
	void bind(RetType(*function_to_bind)(ArgTypes...))
	{
...
public:
	...
	bool operator ! () const { return !m_Closure; } 	// Is it bound to anything?
	bool empty() const { return !m_Closure; }
...
private:	// Invoker for static functions
	RetType InvokeStaticFunction(ArgTypes...args) const
	{
