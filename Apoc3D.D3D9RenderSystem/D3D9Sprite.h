	...
	namespace Graphics
	{
		namespace D3D9RenderSystem
		{
			...
			public:
				...
				virtual void Draw(Texture* texture, const Apoc3D::Math::Rectangle& dstRect, float uScale, float vScale, uint color);
				virtual void Draw(Texture* texture, const PointF& pos, float uScale, float vScale, uint color);
