...
private:
	...
	void OutputDeclaration(const HLSLType& type, const char* name, const char** semantic = NULL, int semanticCount = 0, const char* registerName = NULL, HLSLExpression* defaultValue = NULL);
    void OutputDeclarationType(const HLSLType& type);
    void OutputDeclarationBody(const HLSLType& type, const char* name, const char** semantic =NULL, int semanticCount=0, const char* registerName = NULL, HLSLExpression * assignment = NULL);
